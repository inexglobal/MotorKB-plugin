# MotorKB Plugin for KidBrightIDE
...
| บล็อกภาษาไทย | บล็อกภาษาอังกฤษ |
|--|--|
| ![บล็อกอ่านค่าแอนะล็อก](https://sv1.picz.in.th/images/2019/10/22/gWbMUu.png) | ![analog read](https://sv1.picz.in.th/images/2018/12/25/9ixMO1.png) |
...
บนบอร์ด MotorKB ใช้แรงดันไฟฟ้า 5V และ 3.3V ซึ่งแต่ละจุดต่อจะให้แรงดันเอาต์พุตไม่เท่ากันดังนี้
...
ช่องต่อเหล่านี้จำเป็นต้องใช้งานกับอุปกรณ์ที่ใช้แรงดันไฟฟ้า 3.3V เท่านั้น **มิฉนั้นอาจจะทำให้บอร์ด MotorKB เสียหาย**
...
![ผังแรงดันไฟฟ้าในแต่ละจุดของบอร์ด MotorKB](https://sv1.picz.in.th/images/2019/02/27/TyMmH0.png)
